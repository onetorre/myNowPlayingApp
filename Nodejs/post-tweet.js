...
getTweetObject = function (tweetContent, tweetMediaURL) {
    return {
        status: tweetContent + ' ' + tweetMediaURL + ' ' + '#nowplaying',
    };
}

tweetMyTweetButton = function (tweetContent, tweetMediaURL) {
    T.post('statuses/update', getTweetObject(tweetContent, tweetMediaURL), tweeted);
}
